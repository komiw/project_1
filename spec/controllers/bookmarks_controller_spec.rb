...
describe BookmarksController do
  ...
  def valid_attributes
      ...
      url_name = /(?:[A-Z0-9\-])+/.match(domain_name[0]).nil?
      tld = /(?:[A-Z]{2}|com|edu|gov|net|org|us)/.match(domain_name[1]).nil?
      if url_name == false or tld == false do
        errors.add(:domain_name, 'Invalid url.')
      end
  end
